...
**BLOCKERS:** None outstanding. Q-001 and Q-002 are both resolved; see `30_FERRAMENTAS/03_OWNER_DECISION_SAP_UTILISATION.md` and `20_JOB_ON/08_OWNER_DECISION_ARTICLE_IMAGE.md`.

...
public class JobOnImageWebApiTests : IClassFixture<JobOnImageWebApiTests.ImageFixture>
{
    ...
    public sealed class FakeJobOnRepository : IJobOnRepository
    {
        ...
        public Task SaveRevisionGraphAsync(JobOnRevision revision, string eventType, string actorId, CancellationToken cancellationToken = default) => throw new NotSupportedException();

...
| 4 | N04 | Ferramentas (tool registry) | tables `tool_references`, `tool_lotes`, `physical_pieces`, `tool_check_rules`, `tool_check_occurrences` (**removed by N42**) | N01 `internal_users` |
...
| 6 | N06 | Peso | tables `peso_references`, `peso_lotes`, `peso_controlos`, `peso_leituras`, `peso_comparacao_anterior` (**removed by N37**), `peso_day_approvals`, `peso_settings` | N01 `internal_users`, N05 `job_on`/`job_on_revision` |

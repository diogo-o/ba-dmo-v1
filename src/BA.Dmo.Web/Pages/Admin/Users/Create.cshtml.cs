...
/// audited. Profile title is display text only (UD-02).
/// </summary>
public class CreateModel : PageModel
{
        ...
        string templateId, bool active)
    {
        ...
        var result = await _users.CreateUserAsync(
            new CreateAdminUserRequest(email, password, displayName, profileTitle, templateId, active),
